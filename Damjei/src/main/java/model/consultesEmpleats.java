 ...
 * empleat Seguidament recull la resposta i la tracta segons convingui
 *
...
public class consultesEmpleats {
     ...
     * @throws IOException
     */
    public void carregaTaula(frmEmpleats vista, String token) throws IOException, KeyStoreException, FileNotFoundException, CertificateException, UnrecoverableKeyException, KeyManagementException, NoSuchAlgorithmException {
     ...
     * @throws IOException
     */
    public void carregaEmpleat(int codigo, frmEmpleats vista) throws IOException, KeyStoreException, FileNotFoundException, CertificateException, UnrecoverableKeyException, KeyManagementException, NoSuchAlgorithmException {

        this.vista = vista;
        this.token = token;
        this.vista = vista;
        DemanaDades dades = new DemanaDades();
        ArrayList<String> datescarnet;
        ...
        for (Object empleats : empleat) {
            ...
            datescarnet = dades.data_carnet(idempleado, token);
            String dni = emp2.getDni();
            String nombre = emp2.getNom();
            String apellido = emp2.getApellidos();
            ...
            if (categoria.equals("conductor")) {
                String fecha_carnet = datescarnet.get(0);
                String fecha_caducidad = datescarnet.get(1);
            }
            ...
            if (categoria.equals("conductor")) {
                datescarnet = dades.data_carnet(idempleado, token);
                vista.txtCarnet.setText(datescarnet.get(0));
                vista.txtCarnetCad.setText(datescarnet.get(1));
            }
     ...
     * @throws IOException
     */
    public boolean insertarEmpleat(Empleats empleat, String token) throws IOException, KeyStoreException, FileNotFoundException, CertificateException, UnrecoverableKeyException, KeyManagementException, NoSuchAlgorithmException {
     ...
     * @throws IOException
     */
    public boolean modificarEmpleat(Empleats empleat, String token) throws IOException, KeyStoreException, FileNotFoundException, CertificateException, UnrecoverableKeyException, KeyManagementException, NoSuchAlgorithmException {
     ...
     * @throws IOException
     */
    public boolean eliminarEmpleat(Empleats empleat, String token) throws IOException, KeyStoreException, FileNotFoundException, CertificateException, UnrecoverableKeyException, KeyManagementException, NoSuchAlgorithmException {
