...
public class consultasManteniment {
     ...
     * @throws IOException
     */
    public void carregaTaula(frmManteniment vista, String token) throws IOException, KeyStoreException, FileNotFoundException, CertificateException, UnrecoverableKeyException, KeyManagementException, NoSuchAlgorithmException {
    ...
    /**
     * Mètode que s'encarrega de rebre les dades d'un manteniment concret per
     * poder emplenar els camps de la pestanya de detalls de empleat
     *
    ...
    public void carregaManteniment(int codigo, frmManteniment vista) throws IOException {
        ...
        try {
            ...
            for (JsonElement mantenimientos : mantenimiento) {
                ...
                int id = manteniments.get("idmantenimiento").getAsInt();
                String nombre = manteniments.get("nombre").getAsString();
                Float km = manteniments.get("kilometros_mantenimiento").getAsFloat();
                if (manteniments.has("kilometros_mantenimiento")) {
                    km = manteniments.get("kilometros_mantenimiento").getAsFloat();
                }
                String fecha = manteniments.get("fecha_mantenimiento").getAsString();
            ...
            Logger.getLogger(consultasManteniment.class.getName()).log(Level.SEVERE, null, ex);
     ...
     * @throws IOException
     */
    public boolean insertarManteniment(Mantenimiento manteniment, String token) throws IOException, KeyStoreException, FileNotFoundException, CertificateException, UnrecoverableKeyException, KeyManagementException, NoSuchAlgorithmException {
     ...
     * @throws IOException
     */
    public boolean modificarManteniment(Mantenimiento manteniment, String token) throws IOException, KeyStoreException, FileNotFoundException, CertificateException, UnrecoverableKeyException, KeyManagementException, NoSuchAlgorithmException {
     ...
     * @throws IOException
     */
    public boolean eliminarManteniment(Mantenimiento manteniment, String token) throws IOException, KeyStoreException, FileNotFoundException, CertificateException, UnrecoverableKeyException, KeyManagementException, NoSuchAlgorithmException {
